...
namespace BackVista\DatabaseDumps\Tests\Unit\Service;
...
class ConnectionRegistryTest extends TestCase
{
    ...
    public function testGetPlatformAutoDetected(): void
    {
        ...
        $this->assertInstanceOf(\BackVista\DatabaseDumps\Platform\PostgresPlatform::class, $pgPlatform);
        $this->assertInstanceOf(\BackVista\DatabaseDumps\Platform\MySqlPlatform::class, $mysqlPlatform);
    }
